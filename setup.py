...
setup(
    ...
    description='Django link to Fedora Commons 4',
    long_description=long_description,

    # The project's main homepage.
    url='https://github.com/CESNET/fedoralink',
    ...
    keywords='fedora repository elasticsearch django',
    ...
    #     ],
    # },
    test_suite="fedoralink.tests.runtests.runtests",
)
